  ...
  return (
    <div className="overview">
      ...
      <nav className="section-nav" aria-label="Company sections">
        ...
        <a href="#reports">Reports & exports</a>
      </nav>
      ...
      <div className="split">
        ...
        <div className="stack" id="identity">
          ...
          <div id="reports" className="anchor-section">
            <Panel title="Report & exports" eyebrow="Approval-bound output">
              {data.profile ? (
                <div className="stack-sm">
                  ...
                  <p className="muted" style={{ fontSize: "0.75rem" }}>
                    Exports are generated from the immutable profile content and remain unavailable until a named reviewer approves this exact version.
                  </p>
                  {data.profile.status === "approved" ? (
                    <div className="row">
                      <a className="btn" data-size="sm" href={`/deck/${data.profile.id}/html`} target="_blank" rel="noreferrer noopener">
                        Open HTML report
                      </a>
                      <a className="btn" data-size="sm" href={`/deck/${data.profile.id}/json`} target="_blank" rel="noreferrer noopener">
                        Export JSON
                      </a>
                    </div>
                  ) : data.runs[0] ? (
                ...
                <EmptyState title="No report version exists." detail="Run research through composition to create the first reviewable report." />
              )}
            </Panel>
          </div>
