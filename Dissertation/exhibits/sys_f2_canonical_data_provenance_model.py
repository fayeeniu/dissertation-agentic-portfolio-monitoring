#!/usr/bin/env python3
"""Render SYS-F2's accessible SVG as a deterministic vector PDF."""
...
try:
    ...
    raise SystemExit("ReportLab is required to render SYS-F2") from exc
...
def render(svg_path: Path, output_path: Path) -> None:
    ...
    pdf.setTitle("Canonical data and provenance model")
    pdf.setAuthor("Faye Niu")
    pdf.setSubject("SYS-F2 conceptual data, lineage, approval and export diagram")
